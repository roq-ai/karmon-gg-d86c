...
import { getMinecraftServerById } from 'apiSdk/minecraft-servers';
...
function MinecraftServerViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Minecraft Server Detail View
          </Text>
          {hasAccess('minecraft_server', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/minecraft-servers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
